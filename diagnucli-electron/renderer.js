...
const translations = {
  pt: {
    ...
    nucliUpdateCredsTitle: "Nucli update and credentials fix",
    nucliUpdateCredsDesc: "Atualiza NuCLI e refaz credenciais AWS/CodeArtifact.",
    nucliUpdateCredsTip: "Roda update do NuCLI e reconfigura credenciais.",
    ...
    speedtestTitle: "Testar velocidade da internet",
    speedtestDesc: "Abre o Speedtest dentro do app.",
    speedtestTip: "Executa o teste de velocidade no app.",
  ...
  en: {
    ...
    nucliUpdateCredsTitle: "Nucli update and credentials fix",
    nucliUpdateCredsDesc: "Updates NuCLI and refreshes AWS/CodeArtifact creds.",
    nucliUpdateCredsTip: "Runs NuCLI update and credentials refresh.",
    ...
    speedtestTitle: "Test internet speed",
    speedtestDesc: "Opens Speedtest inside the app.",
    speedtestTip: "Runs the speed test in-app.",
    cleanClutterTitle: "Clean clutter",
  ...
  es: {
    ...
    nucliUpdateCredsTitle: "Nucli update and credentials fix",
    nucliUpdateCredsDesc: "Actualiza NuCLI y refresca credenciales AWS/CodeArtifact.",
    nucliUpdateCredsTip: "Ejecuta update de NuCLI y credenciales.",
    ...
    speedtestTitle: "Probar velocidad de internet",
    speedtestDesc: "Abre Speedtest dentro de la app.",
    speedtestTip: "Ejecuta la prueba de velocidad en la app.",
    cleanClutterTitle: "Clean clutter",
...
const actionLabels = {
  ...
  "speedtest": "Speedtest",
  "nucli-update-credentials": "NuCLI update + credentials fix",
