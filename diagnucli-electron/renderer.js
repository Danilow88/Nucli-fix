...
const translations = {
  pt: {
    ...
    optimizePerfDesc: "Executa ajustes e limpezas para melhorar o desempenho.",
    ...
    macSetupDesc: "Abre o guia no Google Chrome.",
    ...
    restartVpnDesc: "Fecha e reabre o Zscaler.app.",
  ...
  en: {
    ...
    optimizePerfDesc: "Runs performance tuning and cleanup steps.",
    ...
    macSetupDesc: "Opens the guide in Google Chrome.",
    ...
    restartVpnDesc: "Quits and reopens the Zscaler.app.",
  ...
  es: {
    ...
    optimizePerfDesc: "Ejecuta ajustes y limpiezas para mejorar el rendimiento.",
    ...
    macSetupDesc: "Abre la guía en Google Chrome.",
    ...
    restartVpnTitle: "Reiniciar VPN (Zscaler)",
    restartVpnDesc: "Cierra y vuelve a abrir Zscaler.app.",
